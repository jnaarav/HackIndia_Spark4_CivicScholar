...
const NftItem: FunctionComponent<NftItemProps> = ({ item, buyNft }) => {
  ...
  return (
    <>
      <div className="flex-shrink-1 [border-radius:7px_7px_0px_0px] overflow-hidden">
      ...
      <div className="flex-1 bg-gray-900 p-6 flex flex-col justify-between [border-radius:0px_0px_7px_7px]">
