          ...
          <div className="flex-1 flex items-stretch overflow-hidden">
            <main className="flex-1 overflow-y-auto">
              <div className="pt-8 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex">
                  <h1 className="flex-1 text-2xl font-bold text-white">Your NFTs</h1>
                </div>
                      ...
                      <li
                        ...
                        <div
                          className={classNames(
                            ...
                            'group block w-[200px] aspect-w-10 h-[200px] rounded-lg bg-gray-100 overflow-hidden'
                          )}
                        >
                          <img
            ...
            <aside className="hidden w-96 bg-white p-8 border-l border-gray-200 overflow-y-auto lg:block rounded-lg">
            { activeNft &&
